...
* Powered by Quarkus 3.29.1
* Using Fugerit Venus Doc 8.17.6 (extensions : base,freemarker)
...
```shell
./target/unit-test-demo-app-1.0.0-SNAPSHOT-runner
```
...
```shell
mvn io.quarkus.platform:quarkus-maven-plugin:3.29.1:create \
-DprojectGroupId=org.fugerit.java.demo \
-DprojectArtifactId=unit-test-demo-app \
